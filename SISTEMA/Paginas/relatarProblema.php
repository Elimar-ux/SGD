...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
    ...
    <form method="POST" action="../PaginasControle/cRelatarProblema.php">
      <h2>O que deseja relatar ao cliente, <?php echo $nome ?>?</h2>
      <input type="text" name="relato" placeholder="Relatar problema">
